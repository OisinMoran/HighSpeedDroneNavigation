...
String portName = "COM3";      // change this to your COM port 
int NUM_ANCHORS = 4;
...
class positionDataHistory{
    ...
    private int[] prev_position = {0,0,0};
    ...
    private float a = 0.05; // 0<a<1, a=1 gives no IIR filtering
    ...
    public int[] getCurPosition(){
      ...
      for(int i=0; i<3; i++){ // Apply IIR FIlter to X,Y,Z coordinates
        position[i]=(int)((a)*position[i]+(1-a)*prev_position[i]);
      }
